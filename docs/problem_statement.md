...
malicious activity could be overlooked.

## Objective

Develop a lightweight, explainable analytics solution that prioritized
only the most behaviorally unusual PowerShell scripts for analyst review
while integrating into an existing Hadoop environment.
